...
exports.buildLocatorMap = exports.buildNodeModulesTree = exports.getArchivePath = exports.LinkType = void 0;
 ...
 */
exports.getArchivePath = (packagePath) => packagePath.indexOf(`.zip/${NODE_MODULES}/`) >= 0 ?
...
exports.buildLocatorMap = (nodeModulesTree) => {
    const map = new Map();
