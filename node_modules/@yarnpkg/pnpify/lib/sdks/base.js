...
exports.generateEslintBaseWrapper = async (pnpApi, target) => {
...
exports.generateStylelintBaseWrapper = async (pnpApi, target) => {
...
exports.generateSvelteLanguageServerBaseWrapper = async (pnpApi, target) => {
    const wrapper = new generateSdk_1.Wrapper(`svelte-language-server`, { pnpApi, target });
    await wrapper.writeManifest();
    await wrapper.writeBinary(`bin/server.js`);
    return wrapper;
};
exports.generateFlowBinBaseWrapper = async (pnpApi, target) => {
